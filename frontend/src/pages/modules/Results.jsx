...
const Results = () => {
  ...
  const [projectId, setProjectId] = useState(''); // ID del proyecto seleccionado
      ...
      {resultsData ? (
        <>
          <section>
            ...
            {resultsData.projectInfo.map((project, index) => (
          ...
          <section>
            ...
            {resultsData.testPlans.map((testPlan, index) => (
          ...
          <section>
            ...
            {resultsData.defects.map((defect, index) => (
          ...
          <section>
            ...
            {resultsData.assignments.map((assignment, index) => (
          ...
          <section>
            ...
            {resultsData.meetings.map((meeting, index) => (
