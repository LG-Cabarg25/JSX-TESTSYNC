...
import { uploadTestImage } from '../../services/testImagesService'; // Servicio para cargar imágenes
import { registerDefect } from '../../services/defectService'; // Servicio para registrar defectos

const ExecuteTestCaseModal = ({ testCaseId, onClose, token }) => {
