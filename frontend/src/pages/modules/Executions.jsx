...
const Executions = () => {
  ...
  const [userRole, setUserRole] = useState(""); // Estado para el rol del usuario en el proyecto
  ...
  const fetchTestCases = async (planId) => {
    try {
  ...
  const handleUpdateTestCase = (updatedDetails) => {
    // Implementar lógica para actualizar los detalles del caso de prueba
  };
