...
import { getTestPlansByProject, deleteTestPlan } from '../../services/planService';
...
const Planning = () => {
  ...
  const [testPlanIdForNewTestCase, setTestPlanIdForNewTestCase] = useState(null); 
  ...
  const handleAddTestPlan = (newTestPlan) => {
  ...
  const handleDeletePlan = (testPlanId) => {
  ...
  const handleOpenNewTestCaseModal = (testPlanId) => {
